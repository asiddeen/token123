...
<html>
    <head>
        ...
        <title>Reset Password | Queue</title>
        <link rel="icon" type="image/x-icon"  href="{{ asset('assets/fav.ico?v=2') }}">
    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
            <div class="col s12 z-depth-4 card-panel">
                <form class="login-form" action="{{ route('post_reset') }}" method="post" onsubmit="return load()">
                    {{ csrf_field() }}
                    <input type="hidden" name="token" value="{{ $token }}">
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">Queue</p>
                            <p class="center login-form-text" style="letter-spacing:1px">Enter your email and new Password</p>
                        </div>
                    </div>
