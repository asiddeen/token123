...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('installer/img/fav/fav-16x16.png') }}" sizes="16x16"/>
    <link rel="icon" type="image/png" href="{{ asset('installer/img/fav/fav-32x32.png') }}" sizes="32x32"/>
    <link rel="icon" type="image/png" href="{{ asset('installer/img/fav/fav-96x96.png') }}" sizes="96x96"/>
