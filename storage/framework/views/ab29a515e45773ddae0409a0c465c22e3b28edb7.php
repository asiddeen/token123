...
<?php $__env->startSection('content'); ?>
    <div id="callarea" class="row" style="line-height:1.23">
        <div class="col m4">
            ...
            <div class="card-panel center-align" style="margin-bottom:0">
                ...
                <div style="border-bottom:1px solid #ddd">
                    <span id="num1" style="font-size:85px;font-weight:bold;line-height:1.45"><?php echo e($data[1]['number']); ?></span><br>
                    <small id="cou1" style="font-size:35px"><?php echo e($data[1]['counter']); ?></small>
                </div>
                <div style="border-bottom:1px solid #ddd">
                    <span id="num2" style="font-size:85px; font-weight:bold;line-height:1.45"><?php echo e($data[2]['number']); ?></span><br>
                    <small id="cou2" style="font-size:35px"><?php echo e($data[2]['counter']); ?></small>
                </div>
                <div style="border-bottom:1px solid #ddd">
                    <span id="num3" style="font-size:85px;font-weight:bold;line-height:1.45"><?php echo e($data[3]['number']); ?></span><br>
                    <small id="cou3" style="font-size:35px"><?php echo e($data[3]['counter']); ?></small>
                </div>
            </div>
        </div>
        <div class="col m8">
        <!-- <h4 style="color:red">Current Number</h4> -->
            <div class="card-panel center-align" style="margin-bottom:0">
                <span style="font-size:45px">Priority <?php echo e(trans('messages.call.number')); ?></span><br>
                <span id="num0" style="font-size:185px;color:red;font-weight:bold;line-height:1.5"><?php echo e($data[0]['number']); ?></span><br>
                <span style="font-size:40px">Now Serving</span><br>
