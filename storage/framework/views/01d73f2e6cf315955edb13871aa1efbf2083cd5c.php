                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m3">
                            ...
                            <select id="type" class="browser-default">
                                <option value="all"><?php echo e(trans('messages.all')); ?> <?php echo e(trans('messages.types')); ?></option>
                                <option value="missed"><?php echo e(trans('messages.mainapp.menu.reports.missed')); ?></option>
                                <option value="overtime"><?php echo e(trans('messages.mainapp.menu.reports.overtime')); ?></option>
                            </select>
                        </div>
